...
public class Timesheet {
	...
	public static void runtest()  {
		...
		//*******************************************************************************************************************************************************************************************************************************
		driver.findElement(By.xpath("/html[1]/body[1]/div[2]/div[2]/div[1]/div[2]/div[2]/div[1]/table[1]/tbody[1]/tr[1]/td[3]/div[1]/div[1]/div[1]/div[1]/div[1]/table[1]/tbody[1]/tr[30]/td[1]/div[1]")).click();
		System.out.println("Timesheet !!!");
		String textInsideDescription2 =driver.findElement(By.xpath("//input[@type='text'][@name='Description']")).getText();

		// Check whether input field is blank
		if(textInsideDescription2.isEmpty())
		{
//			driver.findElement(By.xpath("//input[@type='text'][@name='Description']")).sendKeys("Sanity on Temp Oracle latest build , Handling Email Syndication Client issues , Explore Rest API automation concepts , Give analysis of custom fields client issue of khan bank");
			WebDriverWait wait = new WebDriverWait(driver,30);
			wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[text()='Save']")));
			System.out.println("Wait successfully!!!");
		...
		driver.findElement(By.xpath("//text()[contains(.,'Close')]/ancestor::button[1]")).click();
